...
import { useAgentStreams } from "./streams/useAgentStreams.js"
import { useRecorderStreams } from "./streams/useRecorderStreams.js"
import { useRunStreams } from "./streams/useRunStreams.js"
import { useTaskRunStreams } from "./streams/useTaskRunStreams.js"
import { useProjectSync } from "./streams/useProjectSync.js"
...
export function useWorkspaceEffects(params: WorkspaceEffectsParams) {
  ...
  useEffect(() => {
    ...
    setCaseForm({
      ...
      apiIntended: Boolean(selectedCase.apiIntended),
    })
