    ...
    <div className="space-y-6">
      ...
      {executionActiveRun && (onDeleteRun || onDeleteArtifacts) ? (
        <div className="space-y-3 pt-2 border-t border-border/40">
          <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">危险操作</div>
          {isRunActive ? (
            <p className="text-[11px] text-muted-foreground italic">运行尚未结束，停止任务后才能删除记录或产物。</p>
          ) : null}
