...
/** 持久 profile 的固定 userDataDir：登录沙盒与回放共用同一目录，cookie/指纹/cf_clearance 跨运行保留。 */
export const resolvePersistentProfileDir = (authProfileId: string) =>
  join(dataDir, "browser-profiles", authProfileId)
