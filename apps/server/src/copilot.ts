...
const buildSystemPrompt = () =>
  [
    ...
    "Assume page, expect, human, ai, test, and http are already available at runtime.",
    "Use 'await http.get(url, options?)' or 'await http.post(url, { data, headers })' to interact with external APIs, such as sending webhook notifications or fetching remote data.",
