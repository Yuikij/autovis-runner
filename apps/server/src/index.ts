...
import { caseApiRoutes } from "./routes/caseApi.js"
...
import { dataTablesRoutes } from "./routes/dataTables.js"
...
await app.register(async (api) => {
  ...
  await api.register(caseApiRoutes)
  ...
  await api.register(dataTablesRoutes)
